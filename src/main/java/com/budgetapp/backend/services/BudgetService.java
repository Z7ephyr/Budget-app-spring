...
import com.budgetapp.backend.dtos.budgets.CreateBudgetDTO; // Import the new DTO
...
public interface BudgetService {
     ...
     *
     * @param createBudgetDTO The budget data to create.
     * @param userId          The ID of the user creating the budget.
     * @return The created BudgetDTO.
     */
    BudgetDTO createBudget(CreateBudgetDTO createBudgetDTO, Long userId);
     ...
     * Returns a list of BudgetDTOs containing:
     ...
     */
    BudgetDTO updateBudget(Long budgetId, CreateBudgetDTO updatedBudgetDTO, Long userId);
